...
<div class='tableauPlaceholder' id='vizStory' style='position: relative; width: 100%;'>
...
<script type='text/javascript'>
  var divElement = document.getElementById('vizStory');
  var vizElement = divElement.getElementsByTagName('object')[0];
  vizElement.style.width = '100%';

  // Force taller height for Story containers
  if (divElement.offsetWidth > 1000) {
    ...
    vizElement.style.height = '2200px'; // long scroll for mobile
  }
