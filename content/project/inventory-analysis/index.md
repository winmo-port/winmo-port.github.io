...
<div class='tableauPlaceholder' id='vizInventory' style='width: 100%; height: 100%;'>
  <noscript>
    <a href='#'>
...
<script type='text/javascript'>
  var divElement = document.getElementById('vizInventory');
  var vizElement = divElement.getElementsByTagName('object')[0];
  // Fill container dynamically
  vizElement.style.width = '100%';
  vizElement.style.height = (window.innerHeight * 0.8) + 'px'; // 80% of viewport height
</script>
